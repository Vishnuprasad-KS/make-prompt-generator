        ...
        <div className="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-md">
          <div className="flex items-start">
            ...
            <p className="text-sm text-blue-700">
              Chat with our AI assistant to create a tailored prompt for your blog post. 
              The assistant will help you customize the template based on your specific needs.
            </p>
          </div>
        </div>
